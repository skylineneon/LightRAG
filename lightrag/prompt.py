...
# 默认元组分割符：tuple_delimiter=PROMPTS["DEFAULT_TUPLE_DELIMITER"]
PROMPTS["DEFAULT_TUPLE_DELIMITER"] = "<|>"
# 默认的记录之间的分隔符
PROMPTS["DEFAULT_RECORD_DELIMITER"] = "##"
# 默认的完整提取结果的结束标志
PROMPTS["DEFAULT_COMPLETION_DELIMITER"] = "<|COMPLETE|>"
# 默认实体类别，包括组织机构、人物、地点、事件、分类标签
...
- entity_name: Name of the entity, use Chinese if the text is in Chinese.
